...
var app = angular.module('quizApp');
    ...
    //$scope.quizName = '/js/quiz/data/csharp.json';
    $scope.quizName = '/api/v1/examen?temaId=1&token=dgdgdgdgdss';
    $scope.score    = 10;
    ...
    $scope.onSubmit = function () {
        ...
        // $http.post('http://franceskynov/api/v1/quiz/submit?token=jnjnjnjnjnjnjnj', answers).success(function (data, status) {
        //    //alert(data);
        // });

    //    $http({
    //         method: 'POST',
    //         url: 'http://franceskynov/api/v1/quiz/submit?token=jnjnjnjnjnjnjnj',
    ...
    $scope.isAnswered = function (index) {
        var answered = 'No se ha respondido';
